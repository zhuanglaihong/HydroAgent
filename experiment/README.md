...
| 条件 | 注入内容 | avg_tokens | avg_time | tool_match |
|------|---------|-----------|---------|-----------|
| K0 | 仅角色描述 | 35,370 | 118s | 1.0 |
| K1 | +Skill 说明书（工作流步骤）| 46,449 | 120s | 1.0 |
| K2 | +领域知识（参数含义/诊断）| 40,048 | 99s | 1.0 |
| K3 | +跨会话记忆（流域档案）| 147,836 | 214s | 1.0 |
...
**测试场景**：T1 标准率定 / T2 参数边界检测 / T3 代码分析
