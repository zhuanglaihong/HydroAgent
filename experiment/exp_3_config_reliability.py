...
TEST_QUERIES = [
    ...
    "用XAJ率定流域02070000，算法scipy，种群200，训练期1990-2000",
    "率定流域11532500的GR4J，GA算法，代数300，种群150，测试期2005-2015",
    "率定XAJ模型，流域03500000，SCE-UA算法，复合体200，warmup365天",
    "用GR4J率定流域02177000，scipy算法，迭代400轮",
    "率定流域03346000的XAJ，GA算法，代数200，训练期1985-1995",
    "GR4J率定流域11532500，SCE-UA，迭代600轮，测试期2010-2015",
    "用XAJ模型率定流域02070000，scipy，种群250",
    "率定GR4J，流域12025000，GA，代数250，种群100",
    "用SCE-UA率定流域02070000的XAJ，复合体150，迭代550轮",
    "率定GR4J模型，流域11532500，算法scipy，迭代450轮",
    "XAJ率定流域11532500，GA算法，代数350，训练期1990-2005",
    "率定流域14325000的GR4J，SCE-UA，复合体180，测试期2005-2014",
    "用XAJ率定流域03500000，scipy，种群220，warmup180天",
    "GR4J率定流域01539000，GA，代数280，种群120",
    "率定XAJ模型，流域14301000，SCE-UA，迭代520轮",
    "用GR4J率定流域14306500，scipy，迭代380轮，训练期1988-1998",
    "率定流域02070000的XAJ，GA，代数220，测试期2008-2013",
    "GR4J模型率定流域12025000，SCE-UA，复合体170，迭代480轮",
    "用XAJ率定流域02070000，scipy，种群230",
    "率定GR4J，流域14306500，GA，代数260，种群140",
    "XAJ率定流域03500000，SCE-UA，复合体190，warmup270天",
    "率定流域14325000的GR4J，scipy，迭代420轮",
    "用XAJ模型率定流域11532500，GA，代数240，训练期1992-2002",
    "GR4J率定流域14325000，SCE-UA，迭代540轮，测试期2006-2011",
    "率定XAJ，流域03346000，scipy，种群210",
    "用GR4J率定流域02070000，GA，代数290，种群130",
    "率定流域01539000的XAJ，SCE-UA，复合体160",
    "GR4J模型率定流域01539000，scipy，迭代460轮，warmup300天",
    "用XAJ率定流域03346000，GA，代数270，训练期1987-1997",

    # 缺省配置 - 部分参数缺失，需自动补全 (20个)
    "率定GR4J模型，流域12025000",  # 缺少算法，应使用默认
    "用XAJ率定流域14301000",  # 缺少算法
    "率定流域14306500，模型GR4J",  # 缺少算法
    "GR4J率定流域12025000，迭代300轮",  # 缺少算法，但有参数
    "用XAJ率定流域02070000，训练期1995-2005",  # 缺少算法和测试期
    "率定流域11532500的GR4J，测试期2010-2020",  # 缺少算法和训练期
    "率定XAJ模型，流域03500000，warmup180天",  # 缺少算法和时间期
    "用GR4J率定流域02177000，复合体150",  # 算法参数不匹配（复合体是SCE-UA的）
    "率定流域03346000，模型XAJ，代数200",  # 缺少算法（代数暗示GA）
    "GR4J率定流域11532500，种群100",  # 缺少算法（种群暗示scipy或GA）
    "用XAJ模型率定流域02070000",  # 完全缺省
    "率定GR4J，流域12025000，SCE-UA算法",  # 缺少迭代参数
    "用XAJ率定流域02070000，scipy算法",  # 缺少种群参数
    "率定流域11532500的GR4J，GA算法",  # 缺少代数和种群
    "率定XAJ模型，流域11532500，训练期只需10年",  # 需推断具体时间
    "用GR4J率定流域14325000，测试期也是10年",  # 需推断具体时间
    "率定流域03500000的XAJ，warmup半年",  # 需转换为天数
    "GR4J率定流域01539000，迭代不用太多，300轮够了",  # 口语化参数
    "用XAJ率定流域14301000，快速率定即可",  # 需推断减少迭代
    "率定流域14306500，用最常用的模型和算法",  # 需推断GR4J和SCE-UA

    # 边界配置 - 极端参数值 (10个)
    "率定GR4J模型，流域02070000，SCE-UA算法，迭代10轮",  # 极小迭代
    "用XAJ率定流域12025000，scipy，种群5",  # 极小种群
    "率定流域02070000的GR4J，GA，代数5，种群5",  # 极小代数和种群
    "率定XAJ，流域14306500，SCE-UA，迭代2000轮",  # 极大迭代
    "用GR4J率定流域03500000，scipy，种群1000",  # 极大种群
    "率定流域14325000的XAJ，GA，代数1000，种群500",  # 极大代数和种群
    "GR4J率定流域11532500，训练期1980-1981",  # 极短训练期（1年）
    "用XAJ率定流域14325000，测试期2020-2021",  # 极短测试期（1年）
    "率定流域03346000的GR4J，warmup1天",  # 极短warmup
    "率定XAJ模型，流域02070000，warmup730天",  # 极长warmup（2年）
]
