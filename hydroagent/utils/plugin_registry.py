"""
External plugin registry for HydroAgent.

Manages ~/.hydroagent/plugins.json (global) and <workspace>/.hydroagent/plugins.json (local).
...
_GLOBAL_DIR = Path.home() / ".hydroagent"
...
class PluginRegistry:
    ...
    def local_path(self) -> Path | None:
        if self._workspace is None:
            return None
        return self._workspace / ".hydroagent" / _PLUGINS_FILENAME
