...
PRIORITY_TOOLS   = 20   # hydroclaw/tools/*.py  — core infrastructure tools
PRIORITY_SKILLS  = 10   # hydroclaw/skills/*/*.py — workflow skill tools
...
def discover_tools(workspace: "Path | None" = None) -> dict[str, Callable]:
    ...
    _scan_dir(package_dir, "hydroclaw.tools", PRIORITY_TOOLS)
...
def reload_tools() -> dict[str, Callable]:
    ...
    to_remove = [
        ...
        and k not in ("hydroclaw.tools", "hydroclaw.skills")
    ]
    for k in to_remove:
        del sys.modules[k]
