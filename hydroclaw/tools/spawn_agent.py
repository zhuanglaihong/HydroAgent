...
The subagent runs as an isolated HydroClaw instance with:
...
def spawn_agent(
    ...
    from hydroclaw.agents import AgentRegistry  # local import: avoids circular dep
    ...
    # ── Build restricted HydroClaw instance ──────────────────────────────
    from hydroclaw.agent import HydroClaw  # local import: avoids circular dep
